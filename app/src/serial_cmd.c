...
static void process_command(const char *cmd) {
    ...
    if (strncmp(cmd, "reboot", len) == 0 || strncmp(cmd, "reset", len) == 0) {
        LOG_INF("Rebooting...");
        ...
        LOG_INF("Commands: !reboot, !boot, !usb, !ble, !pair, !hogp, !forget, !help");
    } else {
