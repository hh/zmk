...
#error "A proper consumer HID report usage range must be selected"
    ...
    /* Touchpad (Report ID 0x20) - iTrack-exact format for iOS */
    0x05, 0x0D,             /* USAGE_PAGE (Digitizers) */
    0x09, 0x05,             /* USAGE (Touch Pad) */
    0xA1, 0x01,             /* COLLECTION (Application) */
    0x85, ZMK_HID_REPORT_ID_TRACKPAD, /* REPORT_ID (0x20) */

    /* Feature: Surface Switch (1 bit) + Report Rate (15 bits) - iTrack exact */
    ...
    /* Input: Scan Time (16 bits) - iTrack exact order */
    ...
    /* Buttons (2 bits + 6 padding) - iTrack exact order */
    ...
    0x46, 0x50, 0x05,       /*     PHYSICAL_MAXIMUM (1360) = 136.0mm */
    0x35, 0x00,             /*     PHYSICAL_MINIMUM (0) */
    0x26, 0x40, 0x06,       /*     LOGICAL_MAXIMUM (1600) */
    0x75, 0x0C,             /*     REPORT_SIZE (12) */
    0x55, 0x0E,             /*     UNIT_EXPONENT (-2) */
    0x65, 0x11,             /*     UNIT (cm) */
    0x09, 0x30,             /*     USAGE (X) */
    0x81, 0x02,             /*     INPUT (Data,Var,Abs) */
    0x46, 0x5C, 0x03,       /*     PHYSICAL_MAXIMUM (860) = 86.0mm */
    0x26, 0xB6, 0x03,       /*     LOGICAL_MAXIMUM (950) */
    0x09, 0x31,             /*     USAGE (Y) */
    0x81, 0x02,             /*     INPUT (Data,Var,Abs) */
    0xC0,                   /*   END_COLLECTION (Finger 1) */

    /* Fingers 2-5 - iTrack exact format (same as finger 1) */
    0x05, 0x0D, 0x09, 0x22, 0xA1, 0x00,
    0x09, 0x42, 0x09, 0x47, 0x75, 0x01, 0x95, 0x02, 0x81, 0x02,
    0x25, 0x05, 0x09, 0x38, 0x75, 0x06, 0x95, 0x01, 0x81, 0x02,
    0x05, 0x01, 0x46, 0x50, 0x05, 0x35, 0x00, 0x26, 0x40, 0x06,
    0x75, 0x0C, 0x55, 0x0E, 0x65, 0x11, 0x09, 0x30, 0x81, 0x02,
    0x46, 0x5C, 0x03, 0x26, 0xB6, 0x03, 0x09, 0x31, 0x81, 0x02, 0xC0,
 ...
 * iTrack-exact format for iOS compatibility.
 */
#if IS_ENABLED(CONFIG_ZMK_USB_HID_TRACKPAD_INTERFACE) && \
    (IS_ENABLED(CONFIG_ZMK_HOGP_TRACKPAD_OUTPUT) || IS_ENABLED(CONFIG_ZMK_HOGP_ITRACK_OUTPUT))
static const uint8_t zmk_hid_trackpad_desc[] = {
    /* Touchpad (Report ID 0x20) - iTrack-exact format */
    0x05, 0x0D,             /* USAGE_PAGE (Digitizers) */
    0x09, 0x05,             /* USAGE (Touch Pad) */
    0xA1, 0x01,             /* COLLECTION (Application) */
    0x85, ZMK_HID_REPORT_ID_TRACKPAD, /* REPORT_ID (0x20) */
